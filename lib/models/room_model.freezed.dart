...
mixin _$RoomModel {
 ...
 int get index; String get roomType; String get roomName; bool? get isGateway; List<SpeedTestRecord> get records;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RoomModel&&(identical(other.index, index) || other.index == index)&&(identical(other.roomType, roomType) || other.roomType == roomType)&&(identical(other.roomName, roomName) || other.roomName == roomName)&&(identical(other.isGateway, isGateway) || other.isGateway == isGateway)&&const DeepCollectionEquality().equals(other.records, records));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,index,roomType,roomName,isGateway,const DeepCollectionEquality().hash(records));

@override
String toString() {
  return 'RoomModel(index: $index, roomType: $roomType, roomName: $roomName, isGateway: $isGateway, records: $records)';
}
...
@useResult
$Res call({
 int index, String roomType, String roomName, bool? isGateway, List<SpeedTestRecord> records
});
...
/// Create a copy of RoomModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? index = null,Object? roomType = null,Object? roomName = null,Object? isGateway = freezed,Object? records = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int index,  String roomType,  String roomName,  bool? isGateway,  List<SpeedTestRecord> records)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RoomModel() when $default != null:
return $default(_that.index,_that.roomType,_that.roomName,_that.isGateway,_that.records);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int index,  String roomType,  String roomName,  bool? isGateway,  List<SpeedTestRecord> records)  $default,) {final _that = this;
switch (_that) {
case _RoomModel():
return $default(_that.index,_that.roomType,_that.roomName,_that.isGateway,_that.records);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int index,  String roomType,  String roomName,  bool? isGateway,  List<SpeedTestRecord> records)?  $default,) {final _that = this;
switch (_that) {
case _RoomModel() when $default != null:
return $default(_that.index,_that.roomType,_that.roomName,_that.isGateway,_that.records);case _:
  return null;
...
class _RoomModel implements RoomModel {
  const _RoomModel({required this.index, required this.roomType, required this.roomName, this.isGateway, final  List<SpeedTestRecord> records = const []}): _records = records;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RoomModel&&(identical(other.index, index) || other.index == index)&&(identical(other.roomType, roomType) || other.roomType == roomType)&&(identical(other.roomName, roomName) || other.roomName == roomName)&&(identical(other.isGateway, isGateway) || other.isGateway == isGateway)&&const DeepCollectionEquality().equals(other._records, _records));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,index,roomType,roomName,isGateway,const DeepCollectionEquality().hash(_records));
...
/// Create a copy of RoomModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? index = null,Object? roomType = null,Object? roomName = null,Object? isGateway = freezed,Object? records = null,}) {
