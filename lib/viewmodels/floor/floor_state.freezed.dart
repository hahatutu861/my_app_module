...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( FloorModel? floor,  int? selectedRoomIndex)?  loaded,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case FloorStateInitial() when initial != null:
return initial();case FloorStateLoading() when loading != null:
return loading();case FloorStateLoaded() when loaded != null:
return loaded(_that.floor,_that.selectedRoomIndex);case FloorStateError() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( FloorModel? floor,  int? selectedRoomIndex)  loaded,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case FloorStateInitial():
return initial();case FloorStateLoading():
return loading();case FloorStateLoaded():
return loaded(_that.floor,_that.selectedRoomIndex);case FloorStateError():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( FloorModel? floor,  int? selectedRoomIndex)?  loaded,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case FloorStateInitial() when initial != null:
return initial();case FloorStateLoading() when loading != null:
return loading();case FloorStateLoaded() when loaded != null:
...
class FloorStateLoaded implements FloorState {
  const FloorStateLoaded({this.floor, this.selectedRoomIndex});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FloorStateLoaded&&(identical(other.floor, floor) || other.floor == floor)&&(identical(other.selectedRoomIndex, selectedRoomIndex) || other.selectedRoomIndex == selectedRoomIndex));
}


@override
int get hashCode => Object.hash(runtimeType,floor,selectedRoomIndex);

@override
String toString() {
  return 'FloorState.loaded(floor: $floor, selectedRoomIndex: $selectedRoomIndex)';
}
...
@useResult
$Res call({
 FloorModel? floor, int? selectedRoomIndex
});
...
/// Create a copy of FloorState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? floor = freezed,Object? selectedRoomIndex = freezed,}) {
