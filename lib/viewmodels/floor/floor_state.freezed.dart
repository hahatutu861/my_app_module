...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( FloorModel? floor,  int? selectedRoomIndex,  bool isReferenceEnabled,  int bubbleTrigger,  bool hasFittedToRooms,  WifiViewMode wifiViewMode)?  loaded,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case FloorStateInitial() when initial != null:
return initial();case FloorStateLoading() when loading != null:
return loading();case FloorStateLoaded() when loaded != null:
return loaded(_that.floor,_that.selectedRoomIndex,_that.isReferenceEnabled,_that.bubbleTrigger,_that.hasFittedToRooms,_that.wifiViewMode);case FloorStateError() when error != null:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( FloorModel? floor,  int? selectedRoomIndex,  bool isReferenceEnabled,  int bubbleTrigger,  bool hasFittedToRooms,  WifiViewMode wifiViewMode)?  loaded,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case FloorStateInitial() when initial != null:
return initial();case FloorStateLoading() when loading != null:
return loading();case FloorStateLoaded() when loaded != null:
...
class FloorStateLoaded implements FloorState {
  const FloorStateLoaded({this.floor, this.selectedRoomIndex, this.isReferenceEnabled = false, this.bubbleTrigger = 0, this.hasFittedToRooms = false, this.wifiViewMode = WifiViewMode.quality});
...
@JsonKey() final  WifiViewMode wifiViewMode;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FloorStateLoaded&&(identical(other.floor, floor) || other.floor == floor)&&(identical(other.selectedRoomIndex, selectedRoomIndex) || other.selectedRoomIndex == selectedRoomIndex)&&(identical(other.isReferenceEnabled, isReferenceEnabled) || other.isReferenceEnabled == isReferenceEnabled)&&(identical(other.bubbleTrigger, bubbleTrigger) || other.bubbleTrigger == bubbleTrigger)&&(identical(other.hasFittedToRooms, hasFittedToRooms) || other.hasFittedToRooms == hasFittedToRooms)&&(identical(other.wifiViewMode, wifiViewMode) || other.wifiViewMode == wifiViewMode));
}


@override
int get hashCode => Object.hash(runtimeType,floor,selectedRoomIndex,isReferenceEnabled,bubbleTrigger,hasFittedToRooms,wifiViewMode);

@override
String toString() {
  return 'FloorState.loaded(floor: $floor, selectedRoomIndex: $selectedRoomIndex, isReferenceEnabled: $isReferenceEnabled, bubbleTrigger: $bubbleTrigger, hasFittedToRooms: $hasFittedToRooms, wifiViewMode: $wifiViewMode)';
}
...
@useResult
$Res call({
 FloorModel? floor, int? selectedRoomIndex, bool isReferenceEnabled, int bubbleTrigger, bool hasFittedToRooms, WifiViewMode wifiViewMode
});
...
/// Create a copy of FloorState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? floor = freezed,Object? selectedRoomIndex = freezed,Object? isReferenceEnabled = null,Object? bubbleTrigger = null,Object? hasFittedToRooms = null,Object? wifiViewMode = null,}) {
...
as bool,wifiViewMode: null == wifiViewMode ? _self.wifiViewMode : wifiViewMode // ignore: cast_nullable_to_non_nullable
as WifiViewMode,
  ));
}
